...
namespace SolitaireiOS.CustomGestures
{
    public class DoubleClickGesture 
    {
        ...
        public UseBoardViewController callerInstance;
        static DoubleClickGesture() { }

        public void InitDoubleClickGesture(UseBoardViewController _context)
        {
            ...
            timer.Elapsed += delegate
            {
                ...
                // TODO: Launch the showDetailsController
